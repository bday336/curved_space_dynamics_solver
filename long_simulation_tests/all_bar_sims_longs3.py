...
# gs2simdatalist[step] = gausss2(startvec=startvec,params=params,dynfunc=dynfunc_h3simbar,dynjac=dynjac_h3simbar,dt=dt)
...
# Sim in S3
np.save("s3_r_gausss1_sim_tmax10_dt00001",gs1simdatalist)
np.save("s3_r_gausss2_sim_tmax10_dt00001",gs2simdatalist)
np.save("s3_r_gausss3_sim_tmax10_dt00001",gs3simdatalist)

data1 = np.load("s3_r_gausss1_sim_tmax10_dt00001.npy")
data2 = np.load("s3_r_gausss2_sim_tmax10_dt00001.npy")
data3 = np.load("s3_r_gausss3_sim_tmax10_dt00001.npy")
