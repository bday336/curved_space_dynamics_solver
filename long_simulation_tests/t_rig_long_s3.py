...
# Sim in H3
# np.save("h3_rig_t_rads2_sim_tmax10_dt01",rs2simdatalist)
# np.save("h3_rig_t_rads3_sim_tmax10_dt01",rs3simdatalist)
...
# data2 = np.load("h3_rig_t_rads2_sim_tmax10_dt01.npy")
# data3 = np.load("h3_rig_t_rads3_sim_tmax10_dt01.npy")
