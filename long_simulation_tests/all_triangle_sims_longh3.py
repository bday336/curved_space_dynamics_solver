...
# Exact in H3
# gs1exactdatalist[step] = gausss1(startvec=startvec,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)
# gs2exactdatalist[step] = gausss2(startvec=startvec,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)
# gs3exactdatalist[step] = gausss3(startvec=startvec,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)

# Sim in H3
gs1simdatalist[step] = gausss1(startvec=startvec,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt)
gs2simdatalist[step] = gausss2(startvec=startvec,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt)
gs3simdatalist[step] = gausss3(startvec=startvec,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt) 

# Exact in S3
# gs1exactdatalist[step] = gausss1(startvec=startvec,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)
# gs2exactdatalist[step] = gausss2(startvec=startvec,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)
# gs3exactdatalist[step] = gausss3(startvec=startvec,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)

# Sim in S3
# gs1simdatalist[step] = gausss1(startvec=startvec,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt)
# gs2simdatalist[step] = gausss2(startvec=startvec,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt)
# gs3simdatalist[step] = gausss3(startvec=startvec,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt) 
...
while (step <= int(t_max/dt+1)):
    # Exact in H3
    # gs1exactdatalist[step] = gausss1(startvec=startvecgs1ex,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)
    # gs2exactdatalist[step] = gausss2(startvec=startvecgs2ex,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)
    # gs3exactdatalist[step] = gausss3(startvec=startvecgs3ex,params=params,dynfunc=dynfunc_h3exacttriangle,dynjac=dynjac_h3exacttriangle,dt=dt)

    #Sim in H3
    gs1simdatalist[step] = gausss1(startvec=startvecgs1sim,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt)
    gs2simdatalist[step] = gausss2(startvec=startvecgs2sim,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt)
    gs3simdatalist[step] = gausss3(startvec=startvecgs3sim,params=params,dynfunc=dynfunc_h3simtriangle,dynjac=dynjac_h3simtriangle,dt=dt)    

    # Exact in S3
    # gs1exactdatalist[step] = gausss1(startvec=startvecgs1ex,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)
    # gs2exactdatalist[step] = gausss2(startvec=startvecgs2ex,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)
    # gs3exactdatalist[step] = gausss3(startvec=startvecgs3ex,params=params,dynfunc=dynfunc_s3exacttriangle,dynjac=dynjac_s3exacttriangle,dt=dt)

    # Sim in S3
    # gs1simdatalist[step] = gausss1(startvec=startvecgs1sim,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt)
    # gs2simdatalist[step] = gausss2(startvec=startvecgs2sim,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt)
    # gs3simdatalist[step] = gausss3(startvec=startvecgs3sim,params=params,dynfunc=dynfunc_s3simtriangle,dynjac=dynjac_s3simtriangle,dt=dt) 
...
# Exact in H3
# np.save("h3_t_gausss1_tmax10_dt01",gs1exactdatalist)
# np.save("h3_t_gausss2_tmax10_dt01",gs2exactdatalist)
# np.save("h3_t_gausss3_tmax10_dt01",gs3exactdatalist)

# np.save("gausss3_gt_tmax10_dt000005",gs3exactdatalist)

# Sim in H3
np.save("h3_t_gausss1_sim_tmax10_dt00001",gs1simdatalist)
np.save("h3_t_gausss2_sim_tmax10_dt00001",gs2simdatalist)
np.save("h3_t_gausss3_sim_tmax10_dt00001",gs3simdatalist)

# Exact in S3
# np.save("s3_t_gausss1_tmax10_dt01",gs1exactdatalist)
# np.save("s3_t_gausss2_tmax10_dt01",gs2exactdatalist)
# np.save("s3_t_gausss3_tmax10_dt01",gs3exactdatalist)

# np.save("gausss3_gt_tmax10_dt000005",gs3exactdatalist)

# Sim in S3
# np.save("s3_t_gausss1_sim_tmax10_dt01",gs1simdatalist)
# np.save("s3_t_gausss2_sim_tmax10_dt01",gs2simdatalist)
# np.save("s3_t_gausss3_sim_tmax10_dt01",gs3simdatalist)

# data1 = np.load("s3_t_gausss1_tmax10_dt01.npy")
# data2 = np.load("s3_t_gausss2_tmax10_dt01.npy")
# data3 = np.load("s3_t_gausss3_tmax10_dt01.npy")

data1 = np.load("h3_t_gausss1_sim_tmax10_dt00001.npy")
data2 = np.load("h3_t_gausss2_sim_tmax10_dt00001.npy")
data3 = np.load("h3_t_gausss3_sim_tmax10_dt00001.npy")
