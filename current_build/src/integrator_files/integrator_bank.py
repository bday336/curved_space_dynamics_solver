...
import numpy as np
from src.integrator_files.rod_derivative_bank import *
from src.integrator_files.triangle_derivative_bank_h3 import *
from src.integrator_files.triangle_derivative_bank_s3 import *
...
def gausss3(startvec, params, dynfunc, dynjac, dt, tol = 1e-15, imax = 100):
    # Set to run Gauss 3-stage method
    a11,a12,a13 = [5./36., 2./9. - np.sqrt(15.)/15., 5./36. - np.sqrt(15.)/30.]
    a21,a22,a23 = [5./36. + np.sqrt(15.)/24., 2./9., 5./36. - np.sqrt(15.)/24.]
    a31,a32,a33 = [5./36. + np.sqrt(15.)/30., 2./9. + np.sqrt(15.)/15., 5./36.]
